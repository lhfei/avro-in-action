 ...
 */
package cn.lhfei.avro.proto;  
@SuppressWarnings("all")
@org.apache.avro.specific.AvroGenerated
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"cn.lhfei.avro.proto\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
  ...
  public static cn.lhfei.avro.proto.Message.Builder newBuilder() {
    return new cn.lhfei.avro.proto.Message.Builder();
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Builder */
  public static cn.lhfei.avro.proto.Message.Builder newBuilder(cn.lhfei.avro.proto.Message.Builder other) {
    return new cn.lhfei.avro.proto.Message.Builder(other);
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Message instance */
  public static cn.lhfei.avro.proto.Message.Builder newBuilder(cn.lhfei.avro.proto.Message other) {
    return new cn.lhfei.avro.proto.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
    ...
    private Builder() {
      super(cn.lhfei.avro.proto.Message.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(cn.lhfei.avro.proto.Message.Builder other) {
      super(other);
    ...
    private Builder(cn.lhfei.avro.proto.Message other) {
            super(cn.lhfei.avro.proto.Message.SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'to' field */
    public cn.lhfei.avro.proto.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    public cn.lhfei.avro.proto.Message.Builder clearTo() {
      to = null;
    ...
    /** Sets the value of the 'from' field */
    public cn.lhfei.avro.proto.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    public cn.lhfei.avro.proto.Message.Builder clearFrom() {
      from = null;
    ...
    /** Sets the value of the 'body' field */
    public cn.lhfei.avro.proto.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    public cn.lhfei.avro.proto.Message.Builder clearBody() {
      body = null;
